// Registro de Estudiante - Formulario de registro para alumnos
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formRegistro) {
        formRegistro.addEventListener('submit', async (e) => {
            ...
            if (!validarIDEstudiante(datos.id)) {
                mostrarAlerta('El ID debe tener el formato EST### (ej: EST001)', 'error');
                return;
            }
